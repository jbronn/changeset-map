...
export function render(container, changesetId, options) {
  ...
  options = options || {};
  options.overpassApiUrl = options.overpassApiUrl || config.overpassApiUrl;
...
function renderHTML(container, changesetId, result, disableSidebar) {
  ...
  ReactDom.render(React.createElement("div", null, React.createElement("div", {
    ...
    className: "cmap-diff-members cmap-scroll-styled"
  })), !disableSidebar && React.createElement(Sidebar, {
    result: result,
    ...
    toggleLayer: function (e) {
      ...
      if (layer === 'satellite') {
        map.renderMap('mapbox://styles/openstreetmap/cjnd8lj0e10i42spfo4nsvoay', result);
      }
